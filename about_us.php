...
<body>
    <div class="flex-container-background">
        ...
        <div class="flex-container" style="border-bottom: 0;
            ...
            <div class="flex-item">
                <h1 id="sub-about">Corporate Headquarters</h1>
                <p id="sub-about">
                    Corporate HQ<br>TYS Bank<br>
                    1985 Cedar Bridge Ave, Suite 3<br>
                    Lakewood, NY 08701
                </p>
            </div>
            <div class="flex-item">
                <h1 id="sub-about">General Contact</h1>
                <p id="sub-about">
                    Toll-Free: 888-968-6822<br>
                    Phone: 732-367-5505<br>
                    Fax: 732-367-2313<br>
                    Email: office@&#8203TYSbank.com
                </p>
            </div>
        </div>
        ...
        <div class="flex-container" style="border-top: 0;
            ...
            <div class="flex-item">
                <h1 id="sub-about">Customer Care (24x7)</h1>
                <p id="sub-about">
                    Toll-Free: 888-966-6992<br>
                    Phone: 732-666-5555<br>
                    Email: care@&#8203TYSbank.com
                </p>
            </div>
            <div class="flex-item">
                <h1 id="sub-about">Live Chat</h1>
                <p id="sub-about">
